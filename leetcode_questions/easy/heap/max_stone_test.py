...
from leetcode_questions.easy.heap.max_stone import max_stone


class TestMaxStone(unittest.TestCase):
    def test_max_stone(self):
        self.assertEqual(max_stone([2, 7, 4, 1, 8, 1]), 1)
        print()
        self.assertEqual(max_stone([1]), 1)
        print()
